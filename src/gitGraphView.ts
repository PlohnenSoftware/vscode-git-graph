...
export class GitGraphView extends BaseGitGraphView {
  ...
  public static createOrShow(
    ...
    if (GitGraphView.currentPanel) {
      ...
      GitGraphView.currentPanel.updateWithRepos(
  ...
  private constructor(
    ...
    // Initialize common functionality shared with other Git Graph views
    this.initializeCommon();
  }
}

export { standardiseCspSource } from "./baseGitGraphView";
